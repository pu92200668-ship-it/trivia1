...
class InicioScene extends Phaser.Scene {
    ...
    create(){
        ...
        // Título del juego
        this.add.text(180,130,"TRIVIA DE GINTAMA",{
            fontSize:"28px",
            color:"#000000"
        }).setOrigin(0.5); // Centrado

        // Botón de comenzar
        let boton = this.add.rectangle(180,350,200,60,0x550000)
            .setInteractive(); // Lo hace clickeable

        this.add.text(180,350,"COMENZAR",{
            fontSize:"20px"
        }).setOrigin(0.5);
...
this.preguntas = [
    {pregunta:"¿Cómo se llama el protagonista principal de la serie?", opciones:["Hijikata","Sakata Gintoki","Gorilla","Naruto Uzumaki"], correcta:1},
    {pregunta:"¿Cómo se llama el negocio que dirige Gintoki?", opciones:["Yorozuya","Ichiraku Ramen","Samurai Service","Reigen"], correcta:0},
    {pregunta:"¿Qué tipo de arma usa principalmente Gintoki?", opciones:["Machete","Katana de Madera","Hacha","Pistola"], correcta:1},

    {pregunta:"¿Cómo se llama la chica alienígena que vive con Gintoki?", opciones:["Tsukuyo","Kagura","Otae","Tama"], correcta:1},
    {pregunta:"¿Cómo se llama el grupo policial al que pertenecen Hijikata y Okita?", opciones:["Kiheitai","Oniwabanshu","Shinsengumi","Tendoshu"], correcta:2},
    {pregunta:"¿Quién dice la frase 'Zura janai, Katsura da'?", opciones:["Sakamoto","Katsura","Gintoki","Hasegawa"], correcta:1},
    {pregunta:"¿Cómo se llama el chico humano que trabaja con Gintoki?", opciones:["Shinpachi","Kondo","Yamazaki","Sadaharu"], correcta:0},
    {pregunta:"¿Cómo se llama el enorme perro blanco del equipo?", opciones:["Sadaharu","Elizabeth","Pakkun","Mutsu"], correcta:0}
];
